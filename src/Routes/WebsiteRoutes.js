...
import UpdateTeacherPay from "Admin/layouts/updateTeacherPay";
...
const routes = [
  ...
  {
    type: "collapse",
    name: "UpdateTeacherPay",
    key: "update-teacher-pay",
    icon: <Icon fontSize="small">add</Icon>,
    route: "/update-teacher-pay/:teacher_id",
    component: <UpdateTeacherPay />,
  },
  {
    type: "collapse",
