...
// export default function FormDialog({ teacher_id, payment_id, onClose }) {
//   const [open, setOpen] = React.useState(true);
//   const [newTeacherId, setTeacherId] = React.useState(teacher_id);
//   const [newPaymentId, setNewPaymentId] = React.useState(payment_id);
