...
import AddSubCategoryForm from "Admin/layouts/updateTeacherPay/components/Addaboutus";

function TeacherPayStatus() {
            ...
            <Card>
              <MDBox p={2}>
                <MDBox p={2} style={{ textAlign: "center" }} lineHeight={0}>
                  <MDTypography variant="h5">Update Teacher Paymentss</MDTypography>
                </MDBox>
...
export default TeacherPayStatus;
